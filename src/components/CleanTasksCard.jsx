...
const DEFAULT_TASKS = [
  ...
  { id: '5', title: 'Write blog draft', completed: false },
  { id: '6', title: 'Review pull requests', completed: false },
];
...
export default function CleanTasksCard() {
  ...
  const handleAddTask = (e) => {
    ...
    setTasks(prev => [...prev, { id: Date.now().toString(), title: newTitle.trim(), completed: false }]);
    setNewTitle('');
    setIsAdding(false);
  };
